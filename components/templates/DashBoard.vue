<template>
  <v-sheet class="groundwork">
    ...
    <v-container fluid>
      ...
      <v-row>
        <v-col cols="12"><CustomerNameInput /></v-col>
      </v-row>
      <v-row>
...
import CustomerNameInput from '../molecules/CustomerNameInput.vue'
@Component({ components: { MostRecentSalesAmount, CustomerList, CustomerNameInput } })
